...
def generate_ad_copy(
    ...
    prompt = (
        ...
        "invitation. If promo_target is present, tailor the wording so it "
        "resonates with that audience. If draft_copy is present, treat it as "
        "the store owner's own rough draft: preserve its core message and any "
        "facts it contains, but rewrite it to match the requested tone and "
        "stay concise — do not copy it verbatim.\n\n"
